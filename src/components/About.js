    ...
    <div className="container" style={myStyle}>
        ...
        <div className="accordion" id="accordionExample" style={myStyle}>
            ...
            <div className="accordion-item">
                ...
                <div className="accordion-body" style={myStyle}>
                    This word counter software works in any web browser such as Chrome, Firefox, Internate Explorer, Safari, Opera. It suits to count character in facebook, blogs, books, pdf documents, essays etc.
                </div>
                </div>
            </div>
        </div>
